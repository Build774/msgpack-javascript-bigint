...
if (msgpack_msgpack) {
  buf = bench('buf = require("@build774/msgpack-bigint").encode(obj);', msgpack_msgpack.encode, data);
  obj = bench('obj = require("@build774/msgpack-bigint").decode(buf);', msgpack_msgpack.decode, buf);
  runTest(obj);
