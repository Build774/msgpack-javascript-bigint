...
```typescript
import { decode } from "@build774/msgpack-bigint";
...
```typescript
import { decodeAsync } from "@build774/msgpack-bigint";
...
```typescript
import { decodeArrayStream } from "@build774/msgpack-bigint";
...
```typescript
import { decodeStream } from "@build774/msgpack-bigint";
...
```typescript
import { deepStrictEqual } from "assert";
import { Encoder, Decoder } from "@build774/msgpack-bigint";
...
```typescript
import { encode, decode, ExtensionCodec } from "@build774/msgpack-bigint";
...
buf = require("@build774/msgpack-bigint").encode(obj);                    |  945400 |  5000 |  189080
obj = require("@build774/msgpack-bigint").decode(buf);                    |  770200 |  5000 |  154040
